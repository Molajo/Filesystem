...
class LocalReadTest extends Data
{
    ...
    protected function setUp()
    {
        ...
        $this->action          = 'Read';
        $this->path            = BASE_FOLDER . '/_dev/Tests/Data/test1.txt';
        $this->options         = array();
    }
    ...
    public function testReadSuccessful()
    {
        ...
        $this->assertEquals(
            BASE_FOLDER . '/_dev/Tests/Data/test1.txt',
            $adapter->fs->path
        );
    ...
    {
        $this->path = BASE_FOLDER . '/_dev/Tests/Data/testreally-is-not-there.txt';
    ...
    {
        $this->path = BASE_FOLDER . '/_dev/Tests';
        $adapter    = new fsAdapter($this->action, $this->path, $this->filesystem_type, $this->options = array());
