...
class LocalMoveTest extends Data
{
    ...
    {
        $temp = BASE_FOLDER . '/_dev/Tests/Data/Testcases';
    ...
    {
        $temp = BASE_FOLDER . '/_dev/Tests/Data';
    ...
    public function testMoveMultipleFolder()
    {
        ...
        $this->path    = BASE_FOLDER . '/_dev/Tests/Data/Testcases';
    ...
    {
        $this->options = array(
            'target_directory'       => BASE_FOLDER . '/_dev/Tests/Data',
            'target_name'            => 'Amy',
            'replace'                => false,
            'target_filesystem_type' => 'Local'
        );
