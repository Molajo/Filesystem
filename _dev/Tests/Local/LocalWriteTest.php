...
class LocalWriteTest extends Data
{
    ...
    {
        if (file_exists(BASE_FOLDER . '/_dev/Tests' . '/' . 'test2.txt')) {
            \unlink(BASE_FOLDER . '/_dev/Tests' . '/' . 'test2.txt');
        }
    ...
    public function testWriteMultipleFolders()
    {
        ...
        $this->path = BASE_FOLDER . '/_dev/Tests/Data/OneMoreFolder/Cats/love/Dogs';
